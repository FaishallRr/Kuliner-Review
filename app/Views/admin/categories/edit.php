...
<div class="p-4 sm:p-6 lg:p-8">
    <div class="mb-6">
        ...
        <p class="text-sm text-slate-500 mt-1">Mengubah kategori <?= esc($category['name']) ?></p>
    </div>
        ...
        <form action="/admin/categories/<?= $category['id'] ?>" method="POST">
            ...
            <div class="mb-5">
                ...
                <textarea name="description" id="description" rows="3"
                    class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-400 focus:bg-white transition-all text-sm resize-none"><?= old('description', $category['description'] ?? '') ?></textarea>
            </div>
